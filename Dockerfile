FROM gradle:8.2.0-jdk17@sha256:dee177c2aa58a90373f4f13c4f9b16cda75a4fc27405e52040c8b29b036feda8 AS cache
WORKDIR /app
ENV GRADLE_USER_HOME /app/gradle
COPY *.gradle.kts gradle.properties /app/
RUN gradle shadowJar --parallel --console=verbose

FROM gradle:8.2.0-jdk17@sha256:dee177c2aa58a90373f4f13c4f9b16cda75a4fc27405e52040c8b29b036feda8 AS build
WORKDIR /app
